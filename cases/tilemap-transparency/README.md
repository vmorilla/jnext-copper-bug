...
> **Status: FIXED.** This no longer reproduces on jnext 0.99.155 — a capture of
> the program now contains 102400 yellow pixels where the report below says
> there was not one. The case is kept as a regression test; the description
> that follows is of the original failure.
